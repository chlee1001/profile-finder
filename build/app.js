...
var _recruitRouter = _interopRequireDefault(require("./routers/recruitRouter"));

var _resumeRouter = _interopRequireDefault(require("./routers/resumeRouter"));
...
app.use("/tm", _express["default"]["static"]("tm"));
...
app.use(_routes["default"].recruits, _recruitRouter["default"]);
app.use(_routes["default"].resumes, _resumeRouter["default"]);
var _default = app;
